...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-Y5CWH6U2.js";
import {
  useConfig
} from "./chunk-ENZPMQSV.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-3KJSZSIM.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-XVESL464.js";
import {
  renderAdmin
} from "./chunk-NKNLLHMX.js";
import {
  useLicenseLimits
...
import {
  Table,
  useTable
} from "./chunk-JRFACQ4P.js";
import {
  useField,
  useForm
} from "./chunk-LJL5RESF.js";
import {
  useRBAC
} from "./chunk-XJQEZORZ.js";
import {
  require_omit
...
import {
  useTracking
} from "./chunk-CUPWDG5I.js";
import {
  ForwardRef$m,
  Page,
  useAPIErrorHandler
} from "./chunk-QN3ZQFWM.js";
import {
  useAuth,
  useQueryParams
} from "./chunk-HUSCX6GM.js";
import {
  useNotification
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-Y5WKLNDP.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-JCOSQCFM.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-5WOCLUOQ.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-CTSYL4TR.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-JVHQXGN6.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-CY2EQYFY.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-J6ANGSB2.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-LEKTC4QS.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-M5DP6HR3.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-YBX22WET.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-VIZUQO2D.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NXAO5GFP.js");
          return {
...
//# sourceMappingURL=chunk-5EH7UKJG.js.map
